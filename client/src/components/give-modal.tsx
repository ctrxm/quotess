  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
      ...
      <div className="relative border-4 border-black rounded-xl bg-white shadow-[8px_8px_0px_black] w-full max-w-sm z-10">
        <div className="flex items-center justify-between p-4 border-b-3 border-black bg-[#FFDD00] rounded-t-lg">
        ...
        <div className="p-5 flex flex-col gap-4">
          <div>
            ...
            <div className="flex items-center gap-2 bg-[#4ADE80] border-2 border-black rounded-lg px-3 py-2">
          ...
          <div ref={searchRef} className="relative">
            ...
            {receiverId ? (
              <div className="flex items-center justify-between bg-[#60A5FA] border-2 border-black rounded-lg px-3 py-2">
                  ...
                  <div className="absolute left-0 right-0 top-full mt-1 bg-white border-2 border-black rounded-lg shadow-[4px_4px_0px_black] z-20 max-h-40 overflow-y-auto">
                    {searchResults.map((u) => (
                      <button
                        ...
                        className="w-full text-left px-3 py-2 text-sm font-bold hover:bg-[#FFDD00] transition-colors first:rounded-t-md last:rounded-b-md"
            ...
            <div className="grid grid-cols-3 gap-2">
              {giftTypes.map((gt) => (
                <button
                  ...
                  className={`flex flex-col items-center gap-1 p-3 border-2 border-black rounded-lg transition-all text-sm font-bold ${selectedGift === gt.id ? "bg-[#FFDD00] shadow-[2px_2px_0px_black]" : "bg-white shadow-[2px_2px_0px_black] hover:shadow-[1px_1px_0px_black] hover:translate-x-[1px] hover:translate-y-[1px]"} disabled:opacity-50 disabled:cursor-not-allowed`}
          ...
          <button
            ...
            className="w-full py-3 bg-[#FFDD00] border-3 border-black rounded-lg font-black text-sm shadow-[4px_4px_0px_black] hover:shadow-[2px_2px_0px_black] hover:translate-x-[2px] hover:translate-y-[2px] transition-all disabled:opacity-50 disabled:cursor-not-allowed"
