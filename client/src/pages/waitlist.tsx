    ...
    return (
      <div className="max-w-md mx-auto px-4 py-16 text-center">
        <div className="border-4 border-black rounded-xl bg-[#A8FF78] p-10 shadow-[8px_8px_0px_black]">
          ...
          <a href="/" className="px-6 py-3 bg-black text-[#A8FF78] font-black border-3 border-black rounded-lg shadow-[4px_4px_0px_#333] inline-block">
            Kembali ke Beranda
          </a>
        </div>
      </div>
  ...
  return (
    <div className="max-w-md mx-auto px-4 py-12">
      <div className="text-center mb-8">
        <div className="w-14 h-14 bg-[#78C1FF] border-3 border-black rounded-xl flex items-center justify-center mx-auto mb-4 shadow-[5px_5px_0px_black]">
      ...
      <div className="border-4 border-black rounded-xl bg-white shadow-[8px_8px_0px_black] p-6">
        <div className="bg-[#FFE34D] border-2 border-black rounded-lg p-3 mb-5 text-sm font-semibold flex items-start gap-2">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col gap-4">
            ...
            <button type="submit" disabled={isLoading} className="w-full py-3 bg-[#FFE34D] border-3 border-black rounded-lg font-black shadow-[5px_5px_0px_black] hover:shadow-[2px_2px_0px_black] hover:translate-x-[3px] hover:translate-y-[3px] transition-all disabled:opacity-60 text-sm" data-testid="button-join-waitlist">
