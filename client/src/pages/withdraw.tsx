...
export default function Withdraw() {
  ...
  if (!user.isGiveEnabled) return (
    <div className="max-w-lg mx-auto px-4 py-12 text-center">
      <div className="border-4 border-black rounded-xl bg-[#FFE34D] p-10 shadow-[8px_8px_0px_black]">
        ...
        <Link href="/profile"><button className="mt-4 px-6 py-2 bg-black text-[#FFE34D] font-black border-2 border-black rounded-lg shadow-[4px_4px_0px_#FFE34D]">Kembali</button></Link>
      </div>
    </div>
  );
  ...
  return (
    <div className="max-w-lg mx-auto px-4 py-8">
      ...
      <div className="border-4 border-black rounded-xl bg-[#FFE34D] p-5 shadow-[6px_6px_0px_black] mb-6">
