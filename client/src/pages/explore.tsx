    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 bg-[#60A5FA] border-3 border-black rounded-lg shadow-[4px_4px_0px_black] flex items-center justify-center">
        ...
        <div className="flex flex-wrap gap-2">
          <button
            ...
            className={`px-4 py-2 font-bold text-sm border-2 border-black rounded-md transition-all duration-100 ${
              activeMood === "" ? "bg-black text-white shadow-[2px_2px_0px_#FFDD00]" : "bg-white shadow-[3px_3px_0px_black] hover:shadow-[1px_1px_0px_black] hover:translate-x-[2px] hover:translate-y-[2px]"
            }`}
          ...
          {Array.from({ length: totalPages }, (_, i) => i + 1).map((p) => (
            <button
              ...
              className={`w-10 h-10 font-black text-sm border-2 border-black rounded-md transition-all ${
                p === page ? "bg-black text-white shadow-[2px_2px_0px_#FFDD00]" : "bg-white shadow-[3px_3px_0px_black] hover:shadow-[1px_1px_0px_black] hover:translate-x-[2px] hover:translate-y-[2px]"
              }`}
