    ...
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center">
        <div className="border-4 border-black rounded-xl bg-[#FFDD00] p-10 shadow-[8px_8px_0px_black]">
          ...
          <Link href="/auth">
            <button className="px-8 py-3 bg-black text-[#FFDD00] font-black border-3 border-black rounded-lg shadow-[4px_4px_0px_#333] hover:shadow-[2px_2px_0px_#333] hover:translate-x-[2px] hover:translate-y-[2px] transition-all" data-testid="button-login-to-submit">
              Login / Daftar
            </button>
          </Link>
        </div>
        ...
        <div className="border-4 border-black rounded-xl bg-[#4ADE80] p-10 shadow-[8px_8px_0px_black]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              ...
              className="px-6 py-3 bg-black text-[#4ADE80] font-black border-3 border-black rounded-lg shadow-[4px_4px_0px_#333] hover:shadow-[2px_2px_0px_#333] hover:translate-x-[2px] hover:translate-y-[2px] transition-all"
    ...
    <div className="max-w-lg mx-auto px-4 py-8">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 bg-[#4ADE80] border-3 border-black rounded-lg shadow-[4px_4px_0px_black] flex items-center justify-center">
          ...
          <form onSubmit={form.handleSubmit((d) => mutate(d))} className="flex flex-col gap-5">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 border-2 border-black rounded-lg font-bold text-sm transition-all ${
                    isAnonymous
                      ? "bg-black text-white shadow-[2px_2px_0px_#FFDD00]"
            ...
            <div>
              ...
              {tags.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {tags.map((t) => (
                    <span key={t} className="inline-flex items-center gap-1 px-3 py-1 bg-[#FFDD00] border-2 border-black rounded-md font-bold text-xs shadow-[2px_2px_0px_black]">
                      #{t}
            ...
            <div className="border-t-2 border-black pt-4">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="w-full py-3 bg-[#FFDD00] text-black font-black border-3 border-black rounded-lg shadow-[5px_5px_0px_black] hover:shadow-[2px_2px_0px_black] hover:translate-x-[3px] hover:translate-y-[3px] transition-all disabled:opacity-60 disabled:cursor-not-allowed text-sm uppercase tracking-wide"
